...
class ANN():
    ...
    def supervised_evaluation(self, top_x=2, double_vote=True):
        ...
        if double_vote:
            ...
            self.classification_report = classification_report(squeezed_labels, most_commons, target_names=self.genre_names, output_dict=True)
            ...
            self.classification_report = classification_report(self.labels, most_commons, target_names=self.genre_names, output_dict=True)
